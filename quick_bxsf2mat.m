...
kz_plane_rotation=str2num(get(handles.edit_kz_plane_rotation, 'String'));
kz_direction=rotz(kz_plane_rotation)*kz_direction';
kz_direction=kz_direction';
...
function edit_kz_plane_rotation_Callback(hObject, eventdata, handles)
% hObject    handle to edit_kz_plane_rotation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_kz_plane_rotation as text
%        str2double(get(hObject,'String')) returns contents of edit_kz_plane_rotation as a double


% --- Executes during object creation, after setting all properties.
function edit_kz_plane_rotation_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_kz_plane_rotation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
