...
% Last Modified by GUIDE v2.5 29-Jun-2017 13:45:24
...
% Hints: contents = cellstr(get(hObject,'String')) returns edit17 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from edit17
